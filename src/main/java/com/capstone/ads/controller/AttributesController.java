...
public class AttributesController {
    ...
    public ApiResponse<AttributesDTO> create(@PathVariable String productTypeId,
        ...
        return ApiResponseBuilder.buildSuccessResponse("Create product type successful", service.create(productTypeId, request));
    }
    ...
    public ApiResponse<AttributesDTO> update(@PathVariable String attributeId,
        ...
        return ApiResponseBuilder.buildSuccessResponse("Update product type successful", service.update(attributeId, request));
    }

    @GetMapping("/attributes/{attributeId}")
    public ApiResponse<AttributesDTO> getById(@PathVariable String attributeId) {
        return ApiResponseBuilder.buildSuccessResponse("Product Type by Id", service.findById(attributeId));
    }
    ...
    public ApiResponse<List<AttributesDTO>> getAll(@PathVariable String productTypeId) {
        return ApiResponseBuilder.buildSuccessResponse("Find all product type", service.findAllByProductTypeId(productTypeId));
    }
