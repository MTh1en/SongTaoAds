...
public class NotificationMessage {
    ...
    public static String CUSTOM_DESIGN_REQUEST_CUSTOMER_DEPOSITED = "%s: Thiết kế đã được đặt cọc thành công";
    public static String CUSTOM_DESIGN_REQUEST_FULLY_PAID = "%s: Đã thanh toán hết hãy gửi bản final";
    public static String CUSTOM_DESIGN_REQUEST_CUSTOMER_FULLY_PAID = "%s: Thiết kế đã được thanh toán hết, hãy chờ Designer gửi bản final";
    ...
    public static String CONTRACT_DISCUSS = "%s: Hợp đồng cần thương thảo. Hãy liên hệ với khách hàng";
    public static String ORDER_IN_PROGRESS = "%s: Đã chuyển qua sản xuất. Hãy cập nhật tiến độ đơn hàng";
    public static String ORDER_DEPOSITED = "%s: Đơn hàng đã được đặt cọc, hãy báo ngày giao dự tính và đơn vị vận chuyển";
    public static String ORDER_CUSTOMER_DEPOSITED = "%s: Đơn hàng đã được đặt cọc thành công";
    public static String ORDER_CUSTOMER_COMPLETED = "%s: Đơn hàng đã thanh toán hết thành công";
