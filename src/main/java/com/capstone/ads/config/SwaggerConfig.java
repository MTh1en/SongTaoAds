...
public class SwaggerConfig {
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                ...
                .addTagsItem(new Tag().name("MODEL CHAT").description("Model chat"))
                .addTagsItem(new Tag().name("FINE TUNE").description("Tinh chỉnh model chat"))
                .addTagsItem(new Tag().name("CHAT BOT").description("Ai chat"))
                .addTagsItem(new Tag().name("CHAT BOT TOPIC").description("Chủ đề của Model Chat"))
                .addTagsItem(new Tag().name("TOPIC").description("Chủ đề"))
                .addTagsItem(new Tag().name("QUESTION").description("Câu hỏi đề xuất"))
